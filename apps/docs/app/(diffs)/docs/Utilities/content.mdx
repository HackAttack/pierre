...
Register a custom TextMate theme for use with either Shiki backend. Use
`registerCustomZedTheme` for Highlights. The theme name you register must match
the `name` field inside your theme JSON file.
